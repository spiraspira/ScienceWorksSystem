...
public static class ContestInitial
{
	...
	[
		new Contest
		{
			...
			DateStart = new DateTime(2024, 01, 01, 0, 0, 0, DateTimeKind.Utc),
			DateStartSecondTour = new DateTime(2024, 02, 01, 0, 0, 0, DateTimeKind.Utc),
			DateEnd = new DateTime(2024, 03, 01, 0, 0, 0, DateTimeKind.Utc),
		...
		new Contest
		{
			...
			Name = "Contest1",
			Description = "Description.",
			DateStart = new DateTime(2024, 05, 01, 0, 0, 0, DateTimeKind.Utc),
			DateStartSecondTour = new DateTime(2024, 06, 01, 0, 0, 0, DateTimeKind.Utc),
			DateEnd = new DateTime(2024, 07, 01, 0, 0, 0, DateTimeKind.Utc),
		...
		new Contest
		{
			...
			Name = "Contest1",
			Description = "Description.",
			DateStart = new DateTime(2024, 03, 01, 0, 0, 0, DateTimeKind.Utc),
			DateStartSecondTour = new DateTime(2024, 04, 01, 0, 0, 0, DateTimeKind.Utc),
			DateEnd = new DateTime(2024, 05, 31, 0, 0, 0, DateTimeKind.Utc),
		...
		new Contest
		{
			...
			Name = "Contest1",
			Description = "Description.",
			DateStart = new DateTime(2024, 08, 01, 0, 0, 0, DateTimeKind.Utc),
			DateStartSecondTour = new DateTime(2024, 09, 01, 0, 0, 0, DateTimeKind.Utc),
			DateEnd = new DateTime(2024, 10, 01, 0, 0, 0, DateTimeKind.Utc),
