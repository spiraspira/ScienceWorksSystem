...
public class CommitteeMemberService(ICommitteeMemberRepository repository, IMapperBase mapper) : GenericService<CommitteeMemberModel, CommitteeMember>(repository, mapper), ICommitteeMemberService
{
