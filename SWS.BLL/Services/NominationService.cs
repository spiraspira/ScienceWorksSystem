...
public class NominationService(INominationRepository repository, IMapper mapper) : GenericService<NominationModel, Nomination>(repository, mapper), INominationService
{
